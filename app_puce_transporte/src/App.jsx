...
// NUEVO: Importa el componente SplashScreen
...
  // NUEVO: Estado para controlar la visibilidad del SplashScreen
...
    fetchUsuarios();
    ...
    // NUEVO: Oculta el splash screen después de 3 segundos
...
      {/* NUEVO: Muestra el SplashScreen si showSplash es true */}
      {showSplash ? (
        <SplashScreen />
      ) : (
        <Routes>
...
            }
          />
          <Route // Nueva ruta para el componente Reservas1
            path="/reservas"
            element={
              <ProtectedRoute usuarioLogeado={usuarioLogeado}>
